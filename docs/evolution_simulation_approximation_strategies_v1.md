...
| Document | Role |
|---|---|
| `evolution_simulation_summary_v6.md` | World, climate, habitats, energy, movement, dispersal, turn order. |
...
**First:** Resolve the reference-model gaps identified in the readiness review. Build the smallest end-to-end individual simulation, deterministic fixtures, inspection, and saved checkpoints.
...
- **[P1]** `evolution_simulation_summary_v6.md`, particularly sections 1-11 and its acceptance checks.
...
- **[P4]** `prompts.md`, particularly application boundaries, scale, themes, and map interaction.
