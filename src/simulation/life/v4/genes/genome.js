/** V4's representative species genome. All costs are experimental model choices. */
export const TRAITS = Object.freeze([
  ...
  ['leafArea', 0, 3], ['shadeTolerance', 0, 3], ['deepRoots', 0, 3],
  ['waxyCuticle', 0, 3], ['buoyancy', 0, 3], ['propaguleDispersal', 0, 3],
  ['camouflage', 0, 3], ['warningSignals', 0, 3], ['ambush', 0, 3],
  ['cooperativeHunting', 0, 3], ['herding', 0, 3], ['burrowing', 0, 3],
...
export function deriveGenome(g) {
  ...
  const traitCost = 0.025 * g.photosynthesis + thermalCost + 0.012 * g.landAdaptation
    ...
    + 0.009 * g.sexualReproduction + 0.035 * g.elevationTolerance + 0.025 * g.depthTolerance + mixedCost
    + 0.018 * g.leafArea + 0.014 * g.shadeTolerance + 0.024 * g.deepRoots
    + 0.012 * g.waxyCuticle + 0.018 * g.buoyancy + 0.009 * g.propaguleDispersal
    + 0.016 * g.camouflage + 0.01 * g.warningSignals + 0.015 * g.ambush
